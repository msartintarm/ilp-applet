...
Binary variable Ivp1, Ivp2, Ivp3;
...
*   channels can be assigned to a link.
    ...
    VCPathRatioNorth_1(x,y)
    VCPathRatioSouth_1(x,y)
    VCPathRatioWest_1(x,y) 
    VCPathRatioEast_1(x,y) 
    ...
    VCPathRatioNorth_3(x,y)
    VCPathRatioSouth_3(x,y)
    VCPathRatioWest_3(x,y) 
    VCPathRatioEast_3(x,y) 

    VCPathRatioCache_1(x,y)
    VCPathRatioCache_2(x,y)
    VCPathRatioCache_3(x,y)

    VCPathRatioDir_1(x,y)
    VCPathRatioDir_2(x,y)
    VCPathRatioDir_3(x,y)
...
MaximumVC(x,y,Port)         .. VCount(x,y,Port) =l= 6;
...
VCPathRatioNorth_1(x,y)       .. 1 * LVC + max_load_on_link * (1 - Ivp1(x,y,'North')) =g= LoadOnLink(x,y-1,'South');
VCPathRatioSouth_1(x,y)       .. 1 * LVC + max_load_on_link * (1 - Ivp1(x,y,'South')) =g= LoadOnLink(x,y+1,'North');
VCPathRatioWest_1(x,y)        .. 1 * LVC + max_load_on_link * (1 - Ivp1(x,y,'West'))  =g= LoadOnLink(x-1,y,'East');
VCPathRatioEast_1(x,y)        .. 1 * LVC + max_load_on_link * (1 - Ivp1(x,y,'East'))  =g= LoadOnLink(x+1,y,'West');

VCPathRatioNorth_2(x,y)       .. 2 * LVC + max_load_on_link * (1 - Ivp2(x,y,'North')) =g= LoadOnLink(x,y-1,'South');
VCPathRatioSouth_2(x,y)       .. 2 * LVC + max_load_on_link * (1 - Ivp2(x,y,'South')) =g= LoadOnLink(x,y+1,'North');
VCPathRatioWest_2(x,y)        .. 2 * LVC + max_load_on_link * (1 - Ivp2(x,y,'West'))  =g= LoadOnLink(x-1,y,'East');
VCPathRatioEast_2(x,y)        .. 2 * LVC + max_load_on_link * (1 - Ivp2(x,y,'East'))  =g= LoadOnLink(x+1,y,'West');

VCPathRatioNorth_3(x,y)       .. 3 * LVC + max_load_on_link * (1 - Ivp3(x,y,'North')) =g= LoadOnLink(x,y-1,'South');
VCPathRatioSouth_3(x,y)       .. 3 * LVC + max_load_on_link * (1 - Ivp3(x,y,'South')) =g= LoadOnLink(x,y+1,'North');
VCPathRatioWest_3(x,y)        .. 3 * LVC + max_load_on_link * (1 - Ivp3(x,y,'West'))  =g= LoadOnLink(x-1,y,'East');
VCPathRatioEast_3(x,y)        .. 3 * LVC + max_load_on_link * (1 - Ivp3(x,y,'East'))  =g= LoadOnLink(x+1,y,'West');

SetVp(x,y,Port)               .. Vp(x,y,Port) =e= Ivp1(x,y,Port) + 2 * Ivp2(x,y,Port) + 3 * Ivp3(x,y,Port);
LimitIvp(x,y,Port)            .. Ivp1(x,y,Port) + Ivp2(x,y,Port) + Ivp3(x,y,Port) =l= 1;

VCPathRatioCache(x,y)         .. LVC * Vp(x,y,'Cache') =g= num_memory_controllers;
VCPathRatioCache_1(x,y)       .. 1 * LVC + num_memory_controllers * (1 - Ivp1(x,y,'Cache')) =g= num_memory_controllers;
VCPathRatioCache_2(x,y)       .. 2 * LVC + num_memory_controllers * (1 - Ivp2(x,y,'Cache')) =g= num_memory_controllers;
VCPathRatioCache_3(x,y)       .. 3 * LVC + num_memory_controllers * (1 - Ivp3(x,y,'Cache')) =g= num_memory_controllers;

VCPathRatioDir(x,y)         .. LVC * Vp(x,y,'Directory') =g= mesh_dimension * mesh_dimension * hasMemoryController(x,y);
VCPathRatioDir_1(x,y)       .. 1 * LVC + mesh_dimension * mesh_dimension * (1 - Ivp1(x,y,'Directory'))
                                                                    =g= mesh_dimension * mesh_dimension * hasMemoryController(x,y);
VCPathRatioDir_2(x,y)       .. 2 * LVC + mesh_dimension * mesh_dimension * (1 - Ivp2(x,y,'Directory'))
                                                                    =g= mesh_dimension * mesh_dimension * hasMemoryController(x,y);
VCPathRatioDir_3(x,y)       .. 3 * LVC + mesh_dimension * mesh_dimension * (1 - Ivp3(x,y,'Directory'))
                                                                    =g= mesh_dimension * mesh_dimension * hasMemoryController(x,y);
...
Model MeshDesignLinearLinksRouters /
                                ...
                                VCPathRatioNorth_3, VCPathRatioSouth_3,
                                VCPathRatioWest_3, VCPathRatioEast_3,
                                SetVp,

                                VCPathRatioCache_1, VCPathRatioCache_2, VCPathRatioCache_3,
                                VCPathRatioDir_1, VCPathRatioDir_2, VCPathRatioDir_3,
