...
CapacityFixedConstraint(x,y,direction)    ..  z =g= LoadOnLink(x,y,direction) / 2;
CapacityVariableConstraint(x,y,direction) ..  2 * mesh_dimension * mesh_dimension * mesh_dimension * mesh_dimension * LinkCap(x,y,direction)
                                                + z =g= LoadOnLink(x,y,direction);
