...
*   Set the Vp value based on the Ivps. This is the unary encoding.
    UnaryVp(x,y,Port)
    LimitIvp(x,y,Port)
    UnaryWvp(x,y,Port)

*   Set the Vp value based on the Ivps. This is the binary encoding.
    BinaryVp(x,y,Port)
    BinaryWvp(x,y,Port)
...
UnaryVp(x,y,Port)               .. Vp(x,y,Port) =e= sum(domVp, (domVp.ord - 1) * Ivp(x,y,Port, domVp));
BinaryVp(x,y,Port)              .. Vp(x,y,Port) =e= sum(domVp, power(2, domVp.ord - 1) * Ivp(x,y,Port, domVp));
LimitIvp(x,y,Port)              .. sum(domVp, Ivp(x,y,Port, domVp)) =e= 1;
UnaryWvp(x,y,Port)              .. Wvp(x,y,Port) =e= sum(domVp, (domVp.ord - 1) * Fvp(x,y,Port, domVp));
BinaryWvp(x,y,Port)             .. Wvp(x,y,Port) =e= sum(domVp, power(2, domVp.ord - 1) * Fvp(x,y,Port, domVp));
