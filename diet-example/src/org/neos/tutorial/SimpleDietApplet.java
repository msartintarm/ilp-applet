 ...
 * It can be run only from within a Jar archive
 * @author Thawan Kooburat
 *
 */
public class SimpleDietApplet extends JApplet {
	...
	private void createGUI() {
		...
		SimpleDietPanel dietPanel = new SimpleDietPanel(FileUtils.APPLET_MODE);
