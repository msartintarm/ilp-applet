...
jarsigner -keystore key/keystore -storepass qawsed -keypass qawsed eclipse/slib/commons-logging-1.1.jar jarkey &&
...
jarsigner -keystore key/keystore -storepass qawsed -keypass qawsed eclipse/slib/plugin.jar jarkey
